...
class VisualiseModellll(component):
    ...
    def RunScript( self, AlpacaStaticOutput , scale, modelExstrud , direction, colorList  ):
        ...
        #----------------------------------------------------------------------#
        def defModelView(AlpacaStaticOutput , scale, Visualise, modelExstrud , direction, colorList  ):
        ...
        #####################################################################################
            ...
            if modelExstrud == False or modelExstrud == None:
                ...
                self.ModelDisp = ExtrudedView

            return segment, colorBeam
        ...
        if checkData != False:
            ...
            ModelDisp, domainValues = defModelView( AlpacaStaticOutput , scale, modelExstrud , direction, colorList  )
            return ModelDisp, domainValues

    def DrawViewportWires(self,arg):
        
        for listcrv, listcolor in zip(self.line, self.colorLine):
            for crv, color in zip( listcrv, listcolor ):
