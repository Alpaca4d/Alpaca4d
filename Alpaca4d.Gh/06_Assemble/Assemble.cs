...
namespace Alpaca4d.Gh
{
    public class AssembleModel : GH_Component
    {
        ...
        {
            pManager.AddGenericParameter("Element", "Element", "", GH_ParamAccess.list);
            pManager.AddGenericParameter("Support", "Support", "", GH_ParamAccess.list);
            pManager.AddGenericParameter("Load", "Load", "", GH_ParamAccess.list);
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.Register_DoubleParam("MassForce", "MassForce", "");
        }
